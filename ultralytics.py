...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=0.3,
        help="Confidence threshold for the model (0.0 - 1.0)",
        type=float,
    )
    parser.add_argument(
        "--iou_threshold",
        default=0.7,
        help="IOU threshold for the model (0.0 - 1.0)",
        type=float
    )

    args = parser.parse_args()
    # Check if the provided thresholds are within valid range (0.0 - 1.0)
