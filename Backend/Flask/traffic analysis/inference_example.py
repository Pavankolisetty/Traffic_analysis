...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source_video_path",
        required=True,
        help=r"C:\Users\pavan kumar\OneDrive - Vignan University\Web dev_CISTUP\Backend\Traffic_analysis\caars.mp4",
        type=str,
    )
    parser.add_argument(
        "--target_video_path",
        default=None,
        help=r"C:\Users\pavan kumar\OneDrive - Vignan University\Web dev_CISTUP\Backend\caars.mp4",
        type=str,
    )
    parser.add_argument(
